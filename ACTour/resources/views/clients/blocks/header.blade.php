        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Hutech University, District 9, HoChiMinh City, Viet Nam</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>+84 0353704987</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>Duongnguyen280403@gmail.com</small>
                </div>
            </div>
